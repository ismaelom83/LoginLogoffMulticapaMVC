...
<html lang="es">
    <head>
        ...
        <link href="WEBBROOT/css/estilos.css"  rel="stylesheet" type="text/css" title="Default style">
            ...
            <nav class="navbar fixed-top navbar-expand-sm navbar-light "  style="background-color: #e3f2fd;">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="DOC/190907DWES-PresentacionTema6.pdf"><b class="tema4">PDFTema6</b></a>
                        </li>
                        <li class="nav-item">
                         
                            <a class="nav-link" href="DOC/190907Tema6Ejercicios.pdf"><b class="tema4">PDFejerciciosTema6</b></a>
                        </li>
                        <li class="nav-item">
